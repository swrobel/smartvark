...
apparel = all.children.create(:name=>"Apparel", :clever_name => "Dress Me")
...
apparel.children.create(:name=>"Accessories")
apparel.children.create(:name=>"Baby")
apparel.children.create(:name=>"Boutique")
apparel.children.create(:name=>"Childrens")
apparel.children.create(:name=>"Formal")
apparel.children.create(:name=>"Mens")
apparel.children.create(:name=>"Shoes")
apparel.children.create(:name=>"Vintage")
apparel.children.create(:name=>"Womens")
...
entertainment.children.create(:name=>"Family")
